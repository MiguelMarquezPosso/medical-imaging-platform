"""Alembic env — runs migrations against the async DB using a sync run-in-async wrapper."""
...
from app.models import user  # noqa: F401  — import models so metadata is populated
